...
class FILESYSTEM(metaclass=Singleton):
    ...
    def load_experiments(self):
        ...
        for experiment_dir in experiments_dirs:
            try:
                ...
                print(f'error loading experiment: {error}')
    ...
    def load_experiment(self, experiment_name: str) -> ExperimentDTO:
        ...
        for operation_dir in operations_dirs:
            ...
            if operation_dto is None:
                continue
            if latest_update_date < operation_dto.operation_datetime:
                latest_update_date = operation_dto.operation_datetime
    ...
    def load_operation(self, experiment_name: str, operation_id: str) -> OperationDTO | None:
        try:
            ...
            print(f'Error loading Operation {operation_id} of Experiment {experiment_name}: {error}')
            return None
    ...
    def delete_operation_dir(self, experiment_name: str, operation_id: str):
        ...
        if os.path.exists(operation_dir_path):
